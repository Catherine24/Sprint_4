...
class MainPage:
    ...
    def process_click_accordion_heading_button_0(self):
        self.click_accordion_heading_button_0()
        self.wait_accordion_heading_button_0()

    def process_click_accordion_heading_button_1(self):
        self.click_accordion_heading_button_1()
        self.wait_accordion_heading_button_1()


    def process_click_accordion_heading_button_2(self):
        self.click_accordion_heading_button_2()
        self.wait_accordion_heading_button_2()


    def process_click_accordion_heading_button_3(self):
        self.click_accordion_heading_button_3()
        self.wait_accordion_heading_button_3()


    def process_click_accordion_heading_button_4(self):
        self.click_accordion_heading_button_4()
        self.wait_accordion_heading_button_4()


    def process_click_accordion_heading_button_5(self):
        self.click_accordion_heading_button_5()
        self.wait_accordion_heading_button_5()


    def process_click_accordion_heading_button_6(self):
        self.click_accordion_heading_button_6()
        self.wait_accordion_heading_button_6()


    def process_click_accordion_heading_button_7(self):
        self.click_accordion_heading_button_7()
        self.wait_accordion_heading_button_7()
